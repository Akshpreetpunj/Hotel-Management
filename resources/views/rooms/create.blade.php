...
@section('content')
    ...
    @csrf
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="id" id="id" placeholder="Room Number"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="max_occupancy" id="max_occupancy" placeholder="Max Occupancy"/>
        </div>
